...
public class EmpDashboardController {
    ...
    private void customerDetailsOnAction(ActionEvent event) {
        openWindow("/lk/ijse/wood_management/customerform.fxml", "Customer Details", event);
    }
    ...
    private void orderDetailsOnAction(ActionEvent event) {
        try {
            Parent root = FXMLLoader.load(
                    getClass().getResource("/lk/ijse/wood_management/orderform.fxml")
            );
    ...
    private void woodDetailsOnAction(ActionEvent event) {
        openWindow("/lk/ijse/wood_management/woodform.fxml", "Wood Details", event);
    }

    @FXML
    private void timberDetailsOnAction(ActionEvent event) {
        openWindow("/lk/ijse/wood_management/timberform.fxml", "Timber Details", event);
    }

    @FXML
    private void cuttingDetailsOnAction(ActionEvent event) {
        openWindow("/lk/ijse/wood_management/cuttingform.fxml", "Cutting Details", event);
    }

    @FXML
    private void billDetailsOnAction(ActionEvent event) {
        openWindow("/lk/ijse/wood_management/billform.fxml", "Bill Details", event);
    }

    @FXML
    private void employeeDetailsOnAction(ActionEvent event) {
        openWindow("/lk/ijse/wood_management/employeeform.fxml", "Employee Details", event);
    }
    @FXML
